...
namespace MarcinWojczalUniversityFaculty.Repositories.Interfaces
{
    ...
    interface IWorkersRepository
    {
        ...
        /// <param name="eMail"></param>
        /// <param name="residencePlaceId"></param>
        void UpdateWorker(string firstName, string lastName, DateTime birthDate, int workPlaceId, string degree, int salary, int phoneNumber, string eMail, int residencePlaceId);
    }
}
